...
var require_two = __commonJS({
  "node_modules/two.js/build/two.js"(exports, module2) {
    var Two5 = (() => {
      ...
      var _Vector = class extends Events2 {
        _x = 0;
        _y = 0;
        constructor(x = 0, y = 0) {
          super();
      ...
      var devicePixelRatio = root2.devicePixelRatio || 1;
      ...
      var Element = class extends Events2 {
        _flagId = false;
      ...
      var _Matrix2 = class extends Events2 {
        ...
        rotate(Number2) {
          const c = cos2(Number2);
          const s = sin2(Number2);
      ...
      function renderArcEstimate(ctx, ox, oy, rx, ry, startAngle, endAngle, clockwise, xAxisRotation) {
        ...
        let deltaAngle = mod(delta, TWO_PI2);
      ...
      Object.defineProperty(dom, "temp", {
        enumerable: true,
        get: function() {
          if (_.isElement(temp) && !root2.document.head.contains(temp)) {
          ...
          if (effect) {
            ...
            if (effect.loaded) {
              ...
              if (this._playing && this._frameRate > 0) {
                ...
                index = lerp2(this._firstFrame, frames, elapsed / duration);
        ...
        _update() {
          if (this._flagVertices || this._flagRadius) {
            ...
            for (let i = 0; i < this.vertices.length; i++) {
              ...
              const lx = rc * cos3(theta - HALF_PI2);
              const ly = rc * sin3(theta - HALF_PI2);
              const rx = rc * cos3(theta + HALF_PI2);
              const ry = rc * sin3(theta + HALF_PI2);
              const v = this.vertices[i];
        ...
        _update() {
          if (this._flagVertices || this._flagWidth || this._flagHeight) {
            ...
            for (let i = 0; i < this.vertices.length; i++) {
              ...
              const lx = radiusX * c * cos4(theta - HALF_PI2);
              const ly = radiusY * c * sin4(theta - HALF_PI2);
              const rx = radiusX * c * cos4(theta + HALF_PI2);
              const ry = radiusY * c * sin4(theta + HALF_PI2);
              const v = this.vertices[i];
              v.command = i === 0 ? Commands.move : Commands.curve;
              v.set(x, y);
              v.controls.left.set(lx, ly);
      ...
      var _ArcSegment = class extends Path {
        ...
        _update() {
          if (this._flagVertices || this._flagStartAngle || this._flagEndAngle || this._flagInnerRadius || this._flagOuterRadius) {
            ...
            const connected = mod(sa, TWO_PI2) === mod(ea, TWO_PI2);
            ...
            for (i = 0, last = length - 1; i < length; i++) {
              ...
              if (v.command === Commands.curve) {
                amp = or * step / Math.PI;
                v.controls.left.x = amp * Math.cos(theta - HALF_PI2);
                v.controls.left.y = amp * Math.sin(theta - HALF_PI2);
                v.controls.right.x = amp * Math.cos(theta + HALF_PI2);
                v.controls.right.y = amp * Math.sin(theta + HALF_PI2);
                if (i === 1) {
    ...
    `
      ...
      var Two6 = _Two;
      __publicField2(Two6, "nextFrameID", Constants.nextFrameID);
      __publicField2(Two6, "Types", Constants.Types);
      __publicField2(Two6, "Version", Constants.Version);
      __publicField2(Two6, "PublishDate", Constants.PublishDate);
      __publicField2(Two6, "Identifier", Constants.Identifier);
      __publicField2(Two6, "Resolution", Constants.Resolution);
      __publicField2(Two6, "AutoCalculateImportedMatrices", Constants.AutoCalculateImportedMatrices);
      __publicField2(Two6, "Instances", Constants.Instances);
      __publicField2(Two6, "uniqueId", Constants.uniqueId);
      __publicField2(Two6, "Anchor", Anchor);
      __publicField2(Two6, "Collection", Collection);
      __publicField2(Two6, "Events", Events2);
      __publicField2(Two6, "Group", Group);
      __publicField2(Two6, "Matrix", Matrix22);
      __publicField2(Two6, "Path", Path);
      __publicField2(Two6, "Registry", Registry);
      __publicField2(Two6, "Shape", Shape);
      __publicField2(Two6, "Text", Text);
      __publicField2(Two6, "Vector", Vector);
      __publicField2(Two6, "Gradient", Gradient);
      __publicField2(Two6, "ImageSequence", ImageSequence);
      __publicField2(Two6, "LinearGradient", LinearGradient);
      __publicField2(Two6, "RadialGradient", RadialGradient);
      __publicField2(Two6, "Sprite", Sprite);
      __publicField2(Two6, "Stop", Stop);
      __publicField2(Two6, "Texture", Texture);
      ...
      __publicField2(Two6, "CanvasRenderer", Renderer);
      __publicField2(Two6, "SVGRenderer", Renderer2);
      __publicField2(Two6, "WebGLRenderer", Renderer3);
      __publicField2(Two6, "Commands", Commands);
...
// src/connection.js
var Connection = class extends import_two.default.Path {
  _name = "connection";
