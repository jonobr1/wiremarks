...
var require_two = __commonJS({
  "node_modules/two.js/build/two.js"(exports, module2) {
    var Two5 = (() => {
      ...
      var __reExport = (target, module3, copyDefault, desc) => {
        if (module3 && typeof module3 === "object" || typeof module3 === "function") {
          for (let key of __getOwnPropNames2(module3))
            if (!__hasOwnProp2.call(target, key) && (copyDefault || key !== "default"))
              __defProp2(target, key, { get: () => module3[key], enumerable: !(desc = __getOwnPropDesc2(module3, key)) || desc.enumerable });
        }
        return target;
      };
      var __toCommonJS2 = /* @__PURE__ */ ((cache) => {
        return (module3, temp2) => {
          return cache && cache.get(module3) || (temp2 = __reExport(__markAsModule({}), module3, 1), cache && cache.set(module3, temp2), temp2);
        };
      ...
      __export2(math_exports, {
        ...
        NumArray: () => NumArray2,
        TWO_PI: () => TWO_PI2,
        decomposeMatrix: () => decomposeMatrix2,
        getComputedMatrix: () => getComputedMatrix2,
        getPoT: () => getPoT,
        lerp: () => lerp3,
        mod: () => mod2,
      ...
      function decomposeMatrix2(matrix3, b, c, d, e, f) {
        let a;
      ...
      function getComputedMatrix2(object, matrix3) {
        matrix3 = matrix3 && matrix3.identity() || new Matrix3();
        let parent = object;
        const matrices = [];
      ...
      function toFixed2(v) {
        return floor3(v * 1e6) / 1e6;
      }
      var curves_exports = {};
      __export2(curves_exports, {
        Curve: () => Curve2,
        getAnchorsFromArcData: () => getAnchorsFromArcData,
        getComponentOnCubicBezier: () => getComponentOnCubicBezier2,
        getControlPoints: () => getControlPoints2,
        getCurveBoundingBox: () => getCurveBoundingBox2,
        getCurveFromPoints: () => getCurveFromPoints2,
        getCurveLength: () => getCurveLength3,
      ...
      __publicField2(Events2, "Methods", [
        "addEventListener",
        "on",
        "removeEventListener",
        "off",
      ...
      __publicField2(Vector2, "zero", new _Vector2());
      __publicField2(Vector2, "left", new _Vector2(-1, 0));
      __publicField2(Vector2, "right", new _Vector2(1, 0));
      __publicField2(Vector2, "up", new _Vector2(0, -1));
      __publicField2(Vector2, "down", new _Vector2(0, 1));
      ...
      function getCurveLength3(x1, y1, x2, y2, x3, y3, x4, y4, limit) {
        ...
        return integrate2(integrand, 0, 1, limit || Curve2.RecursionLimit);
      }
      ...
      function getReflection(a, b, relative) {
        return new Vector2(2 * a.x - (b.x + a.x) - (relative ? a.x : 0), 2 * a.y - (b.y + a.y) - (relative ? a.y : 0));
      }
      function getAnchorsFromArcData(center, xAxisRotation, rx, ry, ts, td, ccw) {
        const resolution = Constants2.Resolution;
        const anchors = [];
        for (let i = 0; i < resolution; i++) {
          ...
          const anchor22 = new Anchor2(x, y);
          anchor22.command = Commands2.line;
      ...
      var tan2 = Math.tan;
      var array2 = [];
      var _Matrix2 = class extends Events2 {
        elements = new NumArray2(9);
        manual = false;
        ...
        set(a, b, c, d, e, f, g, h, i) {
          ...
          this.elements[7] = h;
          this.elements[8] = i;
          return this.trigger(Events2.Types.change);
        }
        copy(m) {
        ...
        rotate(Number2) {
          const c = cos3(Number2);
          const s = sin3(Number2);
        ...
        toString(fullMatrix) {
          array2.length = 0;
          this.toTransformArray(fullMatrix, array2);
          return array2.map(toFixed2).join(" ");
        }
      ...
      var Matrix22 = _Matrix2;
      __publicField2(Matrix22, "Identity", [
        1,
        0,
        0,
        0,
      ...
      var Shape2 = class extends Element2 {
        ...
        get translation() {
          return proto42.position.get.apply(this, arguments);
        }
        set translation(v) {
          proto42.position.set.apply(this, arguments);
        }
        addTo(group) {
          group.add(this);
          return this;
      ...
      var _Group2 = class extends Shape2 {
        ...
        constructor(children) {
          super();
          for (let prop in proto52) {
            Object.defineProperty(this, prop, proto52[prop]);
          }
        ...
        getBoundingClientRect(shallow) {
          ...
          matrix3 = shallow ? this._matrix : getComputedMatrix2(this);
          for (let i = 0; i < this.children.length; i++) {
            const child = this.children[i];
            ...
            top = min4(rect.top, top);
            left = min4(rect.left, left);
            right = max4(rect.right, right);
            bottom = max4(rect.bottom, bottom);
          }
          if (shallow) {
      ...
      var Group2 = _Group2;
      __publicField2(Group2, "Children", Children2);
      ...
      var canvas2 = {
        ...
        group: {
          ...
          render: function(ctx) {
            ...
            const defaultMatrix = isDefaultMatrix2(matrix3);
        ...
        path: {
          render: function(ctx, forced, parentClipped) {
            let matrix3, stroke, linewidth, fill, opacity, visible, cap, join, miter, closed2, commands, length, last, prev, a, b, c, d, ux, uy, vx, vy, ar, bl, br, cl, x, y, mask, clip, defaultMatrix, isOffset, dashes2, po;
            ...
            last = length - 1;
            defaultMatrix = isDefaultMatrix2(matrix3);
            dashes2 = this.dashes;
            if (!defaultMatrix) {
              ctx.save();
              ctx.transform(matrix3[0], matrix3[3], matrix3[1], matrix3[4], matrix3[2], matrix3[5]);
            ...
            for (let i = 0; i < length; i++) {
              ...
              switch (b.command) {
                ...
                case Commands2.arc:
                  ...
                  prev = closed2 ? mod2(i - 1, length) : max22(i - 1, 0);
                  a = commands[prev];
                  ax = a.x;
                  ay = a.y;
                  canvas2.renderSvgArcCommand(ctx, ax, ay, rx, ry, largeArcFlag, sweepFlag, xAxisRotation, x, y);
                  break;
        ...
        points: {
          render: function(ctx, forced, parentClipped) {
            ...
            if (!this._sizeAttenuation) {
              getComputedMatrix2(this, matrix2);
              m = matrix2.elements;
        ...
        renderSvgArcCommand: function(ctx, ax, ay, rx, ry, largeArcFlag, sweepFlag, xAxisRotation, x, y) {
          ...
          const dx2 = (ax - x) / 2;
          const dy2 = (ay - y) / 2;
          const x1p = cos22(xAxisRotation) * dx2 + sin22(xAxisRotation) * dy2;
          const y1p = -sin22(xAxisRotation) * dx2 + cos22(xAxisRotation) * dy2;
          const x1ps = x1p * x1p;
          const y1ps = y1p * y1p;
          let rxs = rx * rx;
          let rys = ry * ry;
          ...
          let q = sqrt2(max22(0, pq));
          if (largeArcFlag === sweepFlag)
            q = -q;
          const cxp = q * rx * y1p / ry;
          const cyp = -q * ry * x1p / rx;
          const cx = cos22(xAxisRotation) * cxp - sin22(xAxisRotation) * cyp + (ax + x) / 2;
          const cy = sin22(xAxisRotation) * cxp + cos22(xAxisRotation) * cyp + (ay + y) / 2;
          const startAngle = svgAngle2(1, 0, (x1p - cxp) / rx, (y1p - cyp) / ry);
          const delta = svgAngle2((x1p - cxp) / rx, (y1p - cyp) / ry, (-x1p - cxp) / rx, (-y1p - cyp) / ry) % TWO_PI2;
          const endAngle = startAngle + delta;
          const clockwise = sweepFlag === 0;
          renderArcEstimate2(ctx, cx, cy, rx, ry, startAngle, endAngle, clockwise, xAxisRotation);
        }
      };
      var Renderer2 = class extends Events2 {
        constructor(params) {
          super();
      ...
      __publicField2(Renderer2, "Utils", canvas2);
      ...
      function svgAngle2(ux, uy, vx, vy) {
        ...
        let ang = acos2(max22(-1, min22(1, dot / len)));
        if (ux * vy - uy * vx < 0) {
          ang = -ang;
        }
        return ang;
      ...
      var dom = {
        hasEventListeners: typeof root2.addEventListener === "function",
        ...
        getRequestAnimationFrame: function() {
          ...
          let lastTime = 0;
          let request = root2.requestAnimationFrame;
          if (!request) {
            for (let i = 0; i < vendors.length; i++) {
              request = root2[vendors[i] + "RequestAnimationFrame"] || request;
            }
          ...
          function fallbackRequest(callback, element) {
            ...
            const id = root2.setTimeout(nextRequest, timeToCall);
      ...
      var temp = root2.document ? root2.document.createElement("div") : {};
      temp.id = "help-two-load";
      Object.defineProperty(dom, "temp", {
        enumerable: true,
        get: function() {
          if (_2.isElement(temp) && !root2.document.head.contains(temp)) {
            temp.style.display = "none";
            root2.document.head.appendChild(temp);
          }
          return temp;
        }
      });
      ...
      function getCurveLength22(a, b, limit) {
      ...
      var _Stop2 = class extends Element2 {
        ...
        constructor(offset, color, opacity) {
          super();
          for (let prop in proto62) {
            Object.defineProperty(this, prop, proto62[prop]);
          }
      ...
      var Stop2 = _Stop2;
      __publicField2(Stop2, "Index", 0);
      __publicField2(Stop2, "Properties", ["offset", "opacity", "color"]);
      var proto62 = {
        offset: {
          enumerable: true,
          get: function() {
      ...
      var _Gradient2 = class extends Element2 {
        ...
        constructor(stops) {
          super();
          for (let prop in proto72) {
            Object.defineProperty(this, prop, proto72[prop]);
          }
      ...
      __publicField2(Gradient2, "Stop", Stop2);
      __publicField2(Gradient2, "Properties", ["spread", "stops", "renderer", "units"]);
      var proto72 = {
        spread: {
          enumerable: true,
          get: function() {
      ...
      var _LinearGradient2 = class extends Gradient2 {
        ...
        constructor(x1, y1, x2, y2, stops) {
          super(stops);
          for (let prop in proto82) {
            Object.defineProperty(this, prop, proto82[prop]);
          }
        ...
        clone(parent) {
          ...
          const clone = new _LinearGradient2(this.left._x, this.left._y, this.right._x, this.right._y, stops);
      ...
      __publicField2(LinearGradient2, "Properties", ["left", "right"]);
      __publicField2(LinearGradient2, "Stop", Stop2);
      var proto82 = {
        left: {
          enumerable: true,
          get: function() {
      ...
      var _RadialGradient2 = class extends Gradient2 {
        ...
        constructor(cx, cy, r, stops, fx, fy) {
          super(stops);
          for (let prop in proto92) {
            Object.defineProperty(this, prop, proto92[prop]);
          }
        ...
        clone(parent) {
          ...
          const clone = new _RadialGradient2(this.center._x, this.center._y, this._radius, stops, this.focal._x, this.focal._y);
      ...
      __publicField2(RadialGradient2, "Stop", Stop2);
      __publicField2(RadialGradient2, "Properties", ["center", "radius", "focal"]);
      var proto92 = {
        radius: {
          enumerable: true,
          get: function() {
      ...
      var _Texture2 = class extends Element2 {
        ...
        constructor(src, callback) {
          super();
          this._renderer = {};
          for (let prop in proto102) {
            Object.defineProperty(this, prop, proto102[prop]);
          }
        ...
        static getImage(src) {
          ...
          if (CanvasShim2.Image) {
            ...
            Renderer2.Utils.shim(image, "img");
          } else if (root2.document) {
            if (regex2.video.test(absoluteSrc)) {
      ...
      __publicField2(Texture2, "Properties", [
        "src",
        "loaded",
        "repeat",
        "scale",
      ...
      __publicField2(Texture2, "RegularExpressions", regex2);
      __publicField2(Texture2, "ImageRegistry", new Registry2());
      __publicField2(Texture2, "Register", {
      ...
      var _Path2 = class extends Shape2 {
        ...
        constructor(vertices, closed2, curved, manual) {
          super();
          for (let prop in proto112) {
            Object.defineProperty(this, prop, proto112[prop]);
          }
        ...
        getBoundingClientRect(shallow) {
          ...
          for (i = 0; i < l; i++) {
            ...
            if (v0.controls && v1.controls) {
              ...
              const bb = getCurveBoundingBox2(v0.x, v0.y, c0x, c0y, c1x, c1y, v1.x, v1.y);
              top = min32(bb.min.y - border, top);
              left = min32(bb.min.x - border, left);
              right = max32(bb.max.x + border, right);
              bottom = max32(bb.max.y + border, bottom);
            } else {
              if (i <= 1) {
                top = min32(v0.y - border, top);
                left = min32(v0.x - border, left);
                right = max32(v0.x + border, right);
                bottom = max32(v0.y + border, bottom);
              }
              top = min32(v1.y - border, top);
              left = min32(v1.x - border, left);
              right = max32(v1.x + border, right);
              bottom = max32(v1.y + border, bottom);
            }
          }
          a = matrix3.multiply(left, top, 1);
          b = matrix3.multiply(left, bottom, 1);
          c = matrix3.multiply(right, top, 1);
          d = matrix3.multiply(right, bottom, 1);
          top = min32(a.y, b.y, c.y, d.y);
          left = min32(a.x, b.x, c.x, d.x);
          right = max32(a.x, b.x, c.x, d.x);
          bottom = max32(a.y, b.y, c.y, d.y);
          return {
            top,
            left,
            right,
        ...
        getPointAt(t, obj) {
          ...
          result = new Anchor2(x, y, brx - x, bry - y, alx - x, aly - y, this._curved ? Commands2.curve : Commands2.line);
          result.t = t;
          return result;
        }
        plot() {
        ...
        _updateLength(limit, silent) {
          ...
          _2.each(this.vertices, function(a, i) {
            ...
            this._lengths[i] = getCurveLength22(a, b, limit);
            sum += this._lengths[i];
            if (i >= last && closed2) {
              b = this.vertices[(i + 1) % length];
              this._lengths[i + 1] = getCurveLength22(a, b, limit);
      ...
      var Path2 = _Path2;
      __publicField2(Path2, "Properties", [
        "fill",
        "stroke",
        "linewidth",
        "opacity",
      ...
      __publicField2(Path2, "Utils", {
        getCurveLength: getCurveLength22
      });
      var proto112 = {
        linewidth: {
          enumerable: true,
      ...
      var _Rectangle = class extends Path2 {
        constructor(x, y, width, height) {
          ...
          for (let prop in proto122) {
            Object.defineProperty(this, prop, proto122[prop]);
          }
        ...
        _update() {
          if (this._flagVertices || this._flagWidth || this._flagHeight) {
            ...
            if (!this._closed && this.vertices.length === 4) {
              this.vertices.push(new Anchor2());
            }
            this.vertices[0].set(-xr, -yr).sub(this._origin).command = Commands2.move;
            this.vertices[1].set(xr, -yr).sub(this._origin).command = Commands2.line;
            this.vertices[2].set(xr, yr).sub(this._origin).command = Commands2.line;
            this.vertices[3].set(-xr, yr).sub(this._origin).command = Commands2.line;
            if (this.vertices[4]) {
              this.vertices[4].set(-xr, -yr).sub(this._origin).command = Commands2.line;
            }
          }
        ...
        clone(parent) {
          ...
          for (let i = 0; i < Path2.Properties.length; i++) {
            const k = Path2.Properties[i];
            clone[k] = this[k];
          }
          if (parent) {
            parent.add(clone);
      ...
      var proto122 = {
        ...
        origin: {
          ...
          set: function(v) {
            if (this._origin) {
              this._origin.unbind(Events2.Types.change, this._renderer.flagVertices);
            }
            this._origin = v;
            this._origin.bind(Events2.Types.change, this._renderer.flagVertices);
            this._renderer.flagVertices();
          }
        }
      };
      var _Sprite = class extends Rectangle {
        ...
        constructor(path, ox, oy, cols, rows, frameRate) {
          ...
          this.noStroke();
          this.noFill();
          if (path instanceof Texture2) {
            this.texture = path;
          } else if (typeof path === "string") {
            this.texture = new Texture2(path);
          }
          this.origin = new Vector2();
          this._update();
        ...
        play(firstFrame, lastFrame, onLastFrame) {
          ...
          this._startTime = _2.performance.now();
          ...
          if (effect) {
            ...
            if (effect.loaded) {
              ...
              if (this._playing && this._frameRate > 0) {
                if (_2.isNaN(this._lastFrame)) {
                  this._lastFrame = amount - 1;
                }
                elapsed = _2.performance.now() - this._startTime;
                ...
                index = lerp3(this._firstFrame, frames, elapsed / duration);
      ...
      var cos32 = Math.cos;
      var sin32 = Math.sin;
      var _Circle = class extends Path2 {
        _flagRadius = false;
        _radius = 0;
        constructor(ox, oy, r, resolution) {
          ...
          const points = [];
          for (let i = 0; i < amount; i++) {
            points.push(new Anchor2(0, 0, 0, 0, 0, 0));
          }
        ...
        _update() {
          if (this._flagVertices || this._flagRadius) {
            ...
            for (let i = 0; i < this.vertices.length; i++) {
              ...
              const x = radius * cos32(theta);
              const y = radius * sin32(theta);
              const lx = rc * cos32(theta - HALF_PI3);
              const ly = rc * sin32(theta - HALF_PI3);
              const rx = rc * cos32(theta + HALF_PI3);
              const ry = rc * sin32(theta + HALF_PI3);
              const v = this.vertices[i];
              v.command = i === 0 ? Commands2.move : Commands2.curve;
              v.set(x, y);
      ...
      var cos4 = Math.cos;
      var sin4 = Math.sin;
      var _Ellipse = class extends Path2 {
        _flagWidth = false;
        _flagHeight = false;
        _width = 0;
        _height = 0;
        ...
        _update() {
          if (this._flagVertices || this._flagWidth || this._flagHeight) {
            ...
            for (let i = 0; i < this.vertices.length; i++) {
              ...
              const lx = radiusX * c * cos4(theta - HALF_PI3);
              const ly = radiusY * c * sin4(theta - HALF_PI3);
              const rx = radiusX * c * cos4(theta + HALF_PI3);
              const ry = radiusY * c * sin4(theta + HALF_PI3);
              const v = this.vertices[i];
              v.command = i === 0 ? Commands2.move : Commands2.curve;
              v.set(x, y);
              v.controls.left.set(lx, ly);
      ...
      var Line = class extends Path2 {
        constructor(x1, y1, x2, y2) {
          ...
          this.vertices[0].command = Commands2.move;
          this.vertices[1].command = Commands2.line;
        ...
        left: {
          ...
          set: function(v) {
            if (_2.isObject(v)) {
              ...
              const error = new TwoError2("Two.Line.x argument is not an object.");
        ...
        right: {
          ...
          set: function(v) {
            if (_2.isObject(v)) {
              ...
              const error = new TwoError2("Two.Line.y argument is not an object.");
              console.warn(error.name, error.message);
            }
          }
        }
      };
      var _RoundedRectangle = class extends Path2 {
        _flagWidth = false;
        _flagHeight = false;
        _flagRadius = false;
        _width = 0;
        ...
        constructor(x, y, width, height, radius) {
          ...
          const points = [];
          for (let i = 0; i < 10; i++) {
            points.push(new Anchor2(0, 0, 0, 0, 0, 0, i === 0 ? Commands2.move : Commands2.curve));
          }
          super(points);
        ...
        _update() {
          if (this._flagVertices || this._flagWidth || this._flagHeight || this._flagRadius) {
            ...
            let rx, ry;
            if (this._radius instanceof Vector2) {
              rx = this._radius.x;
              ry = this._radius.y;
            } else {
              rx = this._radius;
      ...
      var proto17 = {
        ...
        radius: {
          ...
          set: function(v) {
            if (this._radius instanceof Vector2) {
              this._radius.unbind(Events2.Types.change, this._renderer.flagRadius);
            }
            this._radius = v;
            if (this._radius instanceof Vector2) {
              this._radius.bind(Events2.Types.change, this._renderer.flagRadius);
            }
            this._flagRadius = true;
          }
        }
      ...
      var min42 = Math.min;
      var max42 = Math.max;
      var _Text = class extends Shape2 {
        _flagValue = true;
        _flagFamily = true;
        _flagSize = true;
        _flagLeading = true;
        ...
        constructor(message, x, y, styles) {
          ...
          this._renderer.flagFill = FlagFill22.bind(this);
          this._renderer.flagStroke = FlagStroke22.bind(this);
          this.value = message;
          if (typeof x === "number") {
            this.translation.x = x;
          }
        ...
        getBoundingClientRect(shallow) {
          ...
          c = matrix3.multiply(right, top, 1);
          d = matrix3.multiply(right, bottom, 1);
          top = min42(a.y, b.y, c.y, d.y);
          left = min42(a.x, b.x, c.x, d.x);
          right = max42(a.x, b.x, c.x, d.x);
          bottom = max42(a.y, b.y, c.y, d.y);
          return {
            top,
            left,
            right,
      ...
      function applySvgAttributes(node, elem, parentStyles) {
        ...
        let ca, cb, cc, error;
        if (root2.getComputedStyle) {
          const computedStyles = root2.getComputedStyle(node);
        ...
        if (parentStyles) {
          _2.defaults(styles, parentStyles);
        }
        _2.extend(styles, extracted, attributes);
        ...
        for (key in styles) {
          ...
          switch (key) {
            ...
            case "transform":
              ...
              if (m === null)
                break;
              if (Constants2.AutoCalculateImportedMatrices) {
                transforms = decomposeMatrix2(m);
                elem.translation.set(transforms.translateX, transforms.translateY);
                elem.rotation = Math.PI * (transforms.rotation / 180);
                elem.scale = new Vector2(transforms.scaleX, transforms.scaleY);
            ...
            case "fill-opacity":
              ...
              break;
            case "clip-path":
              if (regex22.cssBackgroundImage.test(value)) {
                id = value.replace(regex22.cssBackgroundImage, "$1");
            ...
            case "x":
            case "y":
              ca = elem instanceof Gradient2;
              cb = elem instanceof LinearGradient2;
              cc = elem instanceof RadialGradient2;
              if (ca || cb || cc) {
                break;
              }
              if (value.match("[a-z%]$") && !value.endsWith("px")) {
                error = new TwoError2("only pixel values are supported with the " + key + " attribute.");
                console.warn(error.name, error.message);
              }
      ...
      var read = {
        svg: function(node) {
          const defs = read.defs.current = new Registry2();
          ...
          if (xExists) {
            svg2.x = parseFloat(x.replace(regex22.unitSuffix, ""));
          }
          if (yExists) {
            svg2.y = parseFloat(y.replace(regex22.unitSuffix, ""));
          }
          if (widthExists) {
            svg2.width = parseFloat(width.replace(regex22.unitSuffix, ""));
          }
          if (heightExists) {
            svg2.height = parseFloat(height.replace(regex22.unitSuffix, ""));
          }
          if (viewBoxExists) {
        ...
        use: function(node, styles) {
          ...
          if (!href) {
            error = new TwoError2("encountered <use /> with no href.");
            console.warn(error.name, error.message);
            return null;
          }
          const id = href.slice(1);
          if (!read.defs.current.contains(id)) {
            error = new TwoError2("unable to find element for reference " + href + ".");
            console.warn(error.name, error.message);
            return null;
          }
        ...
        polygon: function(node, parentStyles) {
          ...
          points.replace(/(-?[\d.eE-]+)[,|\s](-?[\d.eE-]+)/g, function(match, p1, p2) {
            verts.push(new Anchor2(parseFloat(p1), parseFloat(p2)));
          });
          const poly = new Path2(verts, true).noStroke();
          poly.fill = "black";
        ...
        path: function(node, parentStyles) {
          ...
          if (path) {
            let coord = new Anchor2();
            let control, coords;
            let commands = path.match(/[a-df-z][^a-df-z]*/ig);
            const last = commands.length - 1;
            _2.each(commands.slice(0), function(command, i) {
              const items = command.slice(1).trim().match(regex22.path);
            ...
            _2.each(commands, function(command, i) {
              let result, x, y;
              const type = command[0];
              const lower = type.toLowerCase();
              coords = command.slice(1).trim().match(regex22.path);
              relative = type === lower;
              ...
              switch (lower) {
                case "z":
                  if (i >= last) {
                    ...
                    x = coord.x;
                    y = coord.y;
                    result = new Anchor2(x, y, void 0, void 0, void 0, void 0, Commands2.close);
                ...
                case "l":
                  ...
                  result = new Anchor2(x, y, void 0, void 0, void 0, void 0, /m/i.test(lower) ? Commands2.move : Commands2.line);
                  if (relative) {
                ...
                case "v":
                  ...
                  b = /x/i.test(a) ? "y" : "x";
                  result = new Anchor2(void 0, void 0, void 0, void 0, void 0, void 0, Commands2.line);
                ...
                case "s":
                  ...
                  result = new Anchor2(x4, y4, x3 - x4, y3 - y4, void 0, void 0, Commands2.curve);
                  coord = result;
                ...
                case "a":
                  ...
                  anchor22 = new Anchor2(x4, y4);
                  anchor22.command = Commands2.arc;
                  anchor22.rx = rx;
                  anchor22.ry = ry;
          ...
          path = new Path2(points, closed2, void 0, true).noStroke();
          path.fill = "black";
          ...
          _2.each(path.vertices, function(v) {
        ...
        "rounded-rect": function(node, parentStyles) {
          ...
          const w2 = width / 2;
          const h2 = height / 2;
          const radius = new Vector2(rx, ry);
        ...
        lineargradient: function(node, parentStyles) {
          ...
          for (let i = 0; i < node.children.length; i++) {
            ...
            stops.push(new Stop2(offset, color, opacity));
          }
          const gradient = new LinearGradient2(x1, y1, x2, y2, stops);
        ...
        radialgradient: function(node, parentStyles) {
          ...
          const gradient = new RadialGradient2(cx, cy, r, stops, fx, fy);
          gradient.spread = spread;
          gradient.units = units;
          applySvgAttributes.call(this, node, gradient, parentStyles);
          return gradient;
        ...
        image: function(node, parentStyles) {
          ...
          const href = node.getAttribute("href") || node.getAttribute("xlink:href");
          if (!href) {
            error = new TwoError2("encountered <image /> with no href.");
            console.warn(error.name, error.message);
            return null;
          }
      ...
      var _ImageSequence = class extends Rectangle {
        ...
        _update() {
          ...
          if (effect) {
            ...
            } else if (this._flagIndex || !(this.fill instanceof Texture2)) {
              texture = effect[this._index];
              if (texture.loaded) {
                width = texture.image.width;
                height = texture.image.height;
      ...
      var proto19 = {
        ...
        textures: {
          ...
          set: function(textures) {
            ...
            if (this._textures) {
              this._textures.unbind(Events2.Types.insert, bindTextures).unbind(Events2.Types.remove, unbindTextures);
            }
            this._textures = new Collection2((textures || []).slice(0));
            this._textures.bind(Events2.Types.insert, bindTextures).bind(Events2.Types.remove, unbindTextures);
      ...
      function BindTextures(items) {
        let i = items.length;
        while (i--) {
          items[i].bind(Events2.Types.change, this._renderer.flagTextures);
        }
      ...
      function UnbindTextures(items) {
        let i = items.length;
        while (i--) {
          items[i].unbind(Events2.Types.change, this._renderer.flagTextures);
        }
        this._renderer.flagTextures();
      }
      function GenerateTexture(obj) {
        if (obj instanceof Texture2) {
          return obj;
        } else if (typeof obj === "string") {
          return new Texture2(obj);
        }
      }
      var _ArcSegment = class extends Path2 {
        ...
        constructor(x, y, ir, or, sa, ea, res) {
          const amount = res || Constants2.Resolution * 3;
          const points = [];
          for (let i = 0; i < amount; i++) {
            points.push(new Anchor2());
          }
        ...
        _update() {
          if (this._flagVertices || this._flagStartAngle || this._flagEndAngle || this._flagInnerRadius || this._flagOuterRadius) {
            ...
            const connected = mod2(sa, TWO_PI2) === mod2(ea, TWO_PI2);
            ...
            for (i = 0, last = length - 1; i < length; i++) {
              ...
              switch (i) {
                case 0:
                  command = Commands2.move;
                  break;
                default:
                  command = Commands2.curve;
              }
              v.command = command;
              v.x = x;
              v.y = y;
              v.controls.left.clear();
              v.controls.right.clear();
              if (v.command === Commands2.curve) {
                amp = or * step / Math.PI;
                v.controls.left.x = amp * Math.cos(theta - HALF_PI3);
                v.controls.left.y = amp * Math.sin(theta - HALF_PI3);
                v.controls.right.x = amp * Math.cos(theta + HALF_PI3);
                v.controls.right.y = amp * Math.sin(theta + HALF_PI3);
                if (i === 1) {
            ...
            if (punctured) {
              if (connected) {
                vertices[id].command = Commands2.close;
                id++;
              } else {
                length--;
                last = length - 1;
              ...
              for (i = 0; i < length; i++) {
                ...
                command = Commands2.curve;
                if (i <= 0) {
                  command = connected ? Commands2.move : Commands2.line;
                }
                v.command = command;
                v.x = x;
                v.y = y;
              ...
              vertices[id].command = Commands2.line;
            } else if (!connected) {
              vertices[id].command = Commands2.line;
              vertices[id].x = 0;
              vertices[id].y = 0;
      ...
      var ceil22 = Math.ceil;
      var floor32 = Math.floor;
      var _Points = class extends Shape2 {
        _flagVertices = true;
        _flagLength = true;
        _flagFill = true;
        _flagStroke = true;
        ...
        toObject() {
          ...
          _2.each(_Points.Properties, function(k) {
            result[k] = this[k];
          }, this);
          result.className = this.className;
          result.translation = this.translation.toObject();
        ...
        noFill = Path2.prototype.noFill;
        noStroke = Path2.prototype.noStroke;
        corner = Path2.prototype.corner;
        center = Path2.prototype.center;
        getBoundingClientRect = Path2.prototype.getBoundingClientRect;
        subdivide(limit) {
          this._update();
          let points = [];
          for (let i = 0; i < this.vertices.length; i++) {
            ...
            const x2 = b.x;
            const y2 = b.y;
            const subdivisions = subdivide2(x1, y1, x1, y1, x2, y2, x2, y2, limit);
            points = points.concat(subdivisions);
          }
          this.vertices = points;
          return this;
        }
        _updateLength = Path2.prototype._updateLength;
        _update() {
          if (this._flagVertices) {
            if (this._flagLength) {
              this._updateLength(void 0, true);
            ...
            const bid = getIdByLength2(this, beginning * this._length);
            const eid = getIdByLength2(this, ending * this._length);
            const low = ceil22(bid);
            const high = floor32(eid);
            let j = 0, v;
            this._renderer.vertices = [];
            this._renderer.collection = [];
            for (let i = 0; i < this._collection.length; i++) {
      ...
      var cos5 = Math.cos;
      var sin5 = Math.sin;
      var _Polygon = class extends Path2 {
        _flagWidth = false;
        _flagHeight = false;
        _flagSides = false;
        _radius = 0;
        ...
        constructor(x, y, radius, sides) {
          ...
          super();
          for (let prop in proto222) {
            Object.defineProperty(this, prop, proto222[prop]);
          }
          this.closed = true;
          this.automatic = false;
          if (typeof radius === "number") {
        ...
        _update() {
          if (this._flagVertices || this._flagWidth || this._flagHeight || this._flagSides) {
            ...
            for (let i = 0; i < amount; i++) {
              ...
              const theta = TWO_PI2 * pct + Math.PI / 2;
              const x = this._width * cos5(theta) / 2;
              const y = this._height * sin5(theta) / 2;
              if (i >= length) {
                this.vertices.push(new Anchor2(x, y));
              } else {
                this.vertices[i].set(x, y);
              }
              this.vertices[i].command = i === 0 ? Commands2.move : Commands2.line;
            }
          }
          super._update.call(this);
          return this;
          ...
          for (let i = 0; i < l; i++) {
            ...
            switch (b.command) {
              ...
              case Commands2.arc:
                ...
                largeArcFlag = b.largeArcFlag;
                sweepFlag = b.sweepFlag;
                command = Commands2.arc + " " + rx + " " + ry + " " + xAxisRotation + " " + largeArcFlag + " " + sweepFlag + " " + x + " " + y;
                break;
              case Commands2.curve:
                ar = a.controls && a.controls.right || Vector2.zero;
                bl = b.controls && b.controls.left || Vector2.zero;
                if (a.relative) {
                  vx = toFixed2(ar.x + a.x);
                  vy = toFixed2(ar.y + a.y);
                } else {
                  vx = toFixed2(ar.x);
                  vy = toFixed2(ar.y);
                }
                if (b.relative) {
                  ux = toFixed2(bl.x + b.x);
                  uy = toFixed2(bl.y + b.y);
                } else {
                  ux = toFixed2(bl.x);
                  uy = toFixed2(bl.y);
                }
                command = (i === 0 ? Commands2.move : Commands2.curve) + " " + vx + " " + vy + " " + ux + " " + uy + " " + x + " " + y;
                break;
              case Commands2.move:
                d = b;
                command = Commands2.move + " " + x + " " + y;
                break;
              default:
                command = b.command + " " + x + " " + y;
            }
            if (i >= last && closed2) {
              if (b.command === Commands2.curve) {
                c = d;
                br = b.controls && b.controls.right || b;
                cl = c.controls && c.controls.left || c;
                if (b.relative) {
                  vx = toFixed2(br.x + b.x);
                  vy = toFixed2(br.y + b.y);
                } else {
                  vx = toFixed2(br.x);
                  vy = toFixed2(br.y);
                }
                if (c.relative) {
                  ux = toFixed2(cl.x + c.x);
                  uy = toFixed2(cl.y + c.y);
                } else {
                  ux = toFixed2(cl.x);
                  uy = toFixed2(cl.y);
                }
        ...
        points: {
          render: function(domElement) {
            ...
            if (this._flagVertices || this._flagSize || this._flagSizeAttenuation) {
              let size = this._size;
              if (!this._sizeAttenuation) {
                getComputedMatrix2(this, matrix22);
                const me = matrix22.elements;
                const m = decomposeMatrix2(me[0], me[3], me[1], me[4], me[2], me[5]);
      ...
      var Renderer22 = class extends Events2 {
        constructor(params) {
          super();
        ...
        setSize(width, height) {
          ...
          return this.trigger(Events2.Types.resize, width, height);
        }
        render() {
      ...
      __publicField2(Renderer22, "Utils", svg);
      var shaders = {
        create: function(gl, source, type) {
          ...
          if (!compiled) {
            ...
            throw new TwoError2("unable to compile shader " + shader + ": " + error);
          }
          return shader;
        },
        types: {
    ...
    `
      ...
      var multiplyMatrix = Matrix22.Multiply;
      var identity = [1, 0, 0, 0, 1, 0, 0, 0, 1];
      var transformation = new NumArray2(9);
      var CanvasUtils = Renderer2.Utils;
      var quad = new NumArray2([
        0,
        0,
        1,
        0,
      ...
      var webgl = {
        precision: 0.9,
        isHidden: /(undefined|none|transparent)/i,
        canvas: root2.document ? root2.document.createElement("canvas") : { getContext: function() {
        } },
        alignments: {
          left: "start",
          middle: "center",
          ...
          render: function(gl, programs) {
            ...
            if (flagParentMatrix || flagMatrix) {
              if (!this._renderer.matrix) {
                this._renderer.matrix = new NumArray2(9);
              }
        ...
        path: {
          ...
          render: function(gl, programs, forcedParent) {
            ...
            const flagTexture = this._flagVertices || this._flagFill || this._fill instanceof LinearGradient2 && (this._fill._flagSpread || this._fill._flagStops || this._fill._flagEndPoints) || this._fill instanceof RadialGradient2 && (this._fill._flagSpread || this._fill._flagStops || this._fill._flagRadius || this._fill._flagCenter || this._fill._flagFocal) || this._fill instanceof Texture2 && (this._fill._flagLoaded && this._fill.loaded || this._fill._flagImage || this._fill._flagVideo || this._fill._flagRepeat || this._fill._flagOffset || this._fill._flagScale) || this._stroke instanceof LinearGradient2 && (this._stroke._flagSpread || this._stroke._flagStops || this._stroke._flagEndPoints) || this._stroke instanceof RadialGradient2 && (this._stroke._flagSpread || this._stroke._flagStops || this._stroke._flagRadius || this._stroke._flagCenter || this._stroke._flagFocal) || this._stroke instanceof Texture2 && (this._stroke._flagLoaded && this._stroke.loaded || this._stroke._flagImage || this._stroke._flagVideo || this._stroke._flagRepeat || this._stroke._flagOffset || this._fill._flagScale) || this._flagStroke || this._flagLinewidth || this._flagOpacity || parent._flagOpacity || this._flagVisible || this._flagCap || this._flagJoin || this._flagMiter || this._flagScale || this.dashes && this.dashes.length > 0 || !this._renderer.texture;
        ...
        points: {
          updateCanvas: function(elem) {
            ...
            ctx.beginPath();
            ctx.arc(0, 0, size / aspect * 0.5, 0, TWO_PI2);
            ctx.restore();
            if (closed) {
              ctx.closePath();
            }
          ...
          render: function(gl, programs, forcedParent) {
            ...
            const flagTexture = this._flagFill || this._fill instanceof LinearGradient2 && (this._fill._flagSpread || this._fill._flagStops || this._fill._flagEndPoints) || this._fill instanceof RadialGradient2 && (this._fill._flagSpread || this._fill._flagStops || this._fill._flagRadius || this._fill._flagCenter || this._fill._flagFocal) || this._fill instanceof Texture2 && (this._fill._flagLoaded && this._fill.loaded || this._fill._flagImage || this._fill._flagVideo || this._fill._flagRepeat || this._fill._flagOffset || this._fill._flagScale) || this._stroke instanceof LinearGradient2 && (this._stroke._flagSpread || this._stroke._flagStops || this._stroke._flagEndPoints) || this._stroke instanceof RadialGradient2 && (this._stroke._flagSpread || this._stroke._flagStops || this._stroke._flagRadius || this._stroke._flagCenter || this._stroke._flagFocal) || this._stroke instanceof Texture2 && (this._stroke._flagLoaded && this._stroke.loaded || this._stroke._flagImage || this._stroke._flagVideo || this._stroke._flagRepeat || this._stroke._flagOffset || this._fill._flagScale) || this._flagStroke || this._flagLinewidth || this._flagOpacity || parent._flagOpacity || this._flagVisible || this._flagScale || this.dashes && this.dashes.length > 0 || !this._renderer.texture;
            if (flagParentMatrix || flagMatrix || parentChanged) {
              if (!this._renderer.matrix) {
                this._renderer.matrix = new NumArray2(9);
              }
        ...
        program: {
          create: function(gl, shaders2) {
            ...
            if (!linked) {
              ...
              throw new TwoError2("unable to link program: " + error);
            }
            return program;
          }
        },
        TextureRegistry: new Registry2()
      };
      webgl.ctx = webgl.canvas.getContext("2d");
      var Renderer3 = class extends Events2 {
        constructor(params) {
          super();
          ...
          this._renderer = {
            type: "renderer",
            matrix: new NumArray2(identity),
            scale: 1,
            opacity: 1
          };
          this._flagMatrix = true;
          params = _2.defaults(params || {}, {
            antialias: false,
            alpha: true,
          ...
          if (!this.ctx) {
            throw new TwoError2("unable to create a webgl context. Try using another renderer.");
          }
        ...
        setSize(width, height, ratio) {
          ...
          this.width = width;
          this.height = height;
          this.ratio = typeof ratio === "undefined" ? getRatio2(ctx) : ratio;
          this.domElement.width = width * this.ratio;
          this.domElement.height = height * this.ratio;
          if (_2.isObject(this.domElement.style)) {
            _2.extend(this.domElement.style, {
              width: width + "px",
              height: height + "px"
            });
      ...
      var Utils = _2.extend({
        ...
        read,
        xhr
      }, _2, CanvasShim2, curves_exports, math_exports);
      var _Two = class {
        _events = new Events2();
        get _bound() {
          return this._events._bound;
        ...
        playing = false;
        constructor(options) {
          const params = _2.defaults(options || {}, {
            fullscreen: false,
            fitted: false,
            width: 640,
            height: 480,
          ...
          _2.each(params, function(v, k) {
            if (/fullscreen/i.test(k) || /autostart/i.test(k)) {
              return;
            }
            this[k] = v;
          }, this);
          if (_2.isElement(params.domElement)) {
          ...
          if (params.fullscreen) {
            ...
            _2.extend(this.renderer.domElement.style, {
              display: "block",
              top: 0,
              left: 0,
              right: 0,
          ...
          } else if (!_2.isElement(params.domElement)) {
            this.renderer.setSize(params.width, params.height, this.ratio);
            this.width = params.width;
            this.height = params.height;
          }
          this.renderer.bind(Events2.Types.resize, updateDimensions.bind(this));
        ...
        play() {
          this.playing = true;
          raf.init();
          return this.trigger(Events2.Types.play);
        }
        pause() {
          this.playing = false;
          return this.trigger(Events2.Types.pause);
        }
        setPlaying(p) {
          this.playing = p;
        }
        ...
        update() {
          ...
          this.trigger(Events2.Types.update, this.frameCount, this.timeDelta);
          return this.render();
        }
        render() {
          this.renderer.render();
          return this.trigger(Events2.Types.render, this.frameCount++);
        }
        add(objects) {
          if (!(objects instanceof Array)) {
            objects = Array.prototype.slice.call(arguments);
        ...
        makeArrow(x1, y1, x2, y2, size) {
          ...
          const vertices = [
            new Anchor2(x1, y1, void 0, void 0, void 0, void 0, Commands2.move),
            new Anchor2(x2, y2, void 0, void 0, void 0, void 0, Commands2.line),
            new Anchor2(x2 - headlen * Math.cos(angle - Math.PI / 4), y2 - headlen * Math.sin(angle - Math.PI / 4), void 0, void 0, void 0, void 0, Commands2.line),
            new Anchor2(x2, y2, void 0, void 0, void 0, void 0, Commands2.move),
            new Anchor2(x2 - headlen * Math.cos(angle + Math.PI / 4), y2 - headlen * Math.sin(angle + Math.PI / 4), void 0, void 0, void 0, void 0, Commands2.line)
          ];
          const path = new Path2(vertices, false, false, true);
          path.noFill();
          path.cap = "round";
          path.join = "round";
          this.scene.add(path);
        ...
        makeCurve(points) {
          ...
          if (!Array.isArray(points)) {
            ...
            for (let i = 0; i < l; i += 2) {
              ...
              points.push(new Anchor2(x, y));
            }
          }
          const last = arguments[l - 1];
          const curve = new Path2(points, !(typeof last === "boolean" ? last : void 0), true);
        ...
        makePath(p) {
          ...
          const last = arguments[l - 1];
          const path = new Path2(points, !(typeof last === "boolean" ? last : void 0));
        ...
        makeRadialGradient(x1, y1, radius) {
          ...
          const gradient = new RadialGradient2(x1, y1, radius, stops);
          this.add(gradient);
          return gradient;
        }
        ...
        makeTexture(pathOrSource, callback) {
          const texture = new Texture2(pathOrSource, callback);
          return texture;
        }
        makeGroup(objects) {
          if (!(objects instanceof Array)) {
      ...
      var Two6 = _Two;
      __publicField2(Two6, "nextFrameID", Constants2.nextFrameID);
      __publicField2(Two6, "Types", Constants2.Types);
      __publicField2(Two6, "Version", Constants2.Version);
      __publicField2(Two6, "PublishDate", Constants2.PublishDate);
      __publicField2(Two6, "Identifier", Constants2.Identifier);
      __publicField2(Two6, "Resolution", Constants2.Resolution);
      __publicField2(Two6, "AutoCalculateImportedMatrices", Constants2.AutoCalculateImportedMatrices);
      __publicField2(Two6, "Instances", Constants2.Instances);
      __publicField2(Two6, "uniqueId", Constants2.uniqueId);
      __publicField2(Two6, "Anchor", Anchor2);
      __publicField2(Two6, "Collection", Collection2);
      __publicField2(Two6, "Events", Events2);
      __publicField2(Two6, "Group", Group2);
      __publicField2(Two6, "Matrix", Matrix22);
      __publicField2(Two6, "Path", Path2);
      __publicField2(Two6, "Registry", Registry2);
      __publicField2(Two6, "Shape", Shape2);
      __publicField2(Two6, "Text", Text);
      __publicField2(Two6, "Vector", Vector2);
      __publicField2(Two6, "Gradient", Gradient2);
      __publicField2(Two6, "ImageSequence", ImageSequence);
      __publicField2(Two6, "LinearGradient", LinearGradient2);
      __publicField2(Two6, "RadialGradient", RadialGradient2);
      __publicField2(Two6, "Sprite", Sprite);
      __publicField2(Two6, "Stop", Stop2);
      __publicField2(Two6, "Texture", Texture2);
      __publicField2(Two6, "ArcSegment", ArcSegment);
      __publicField2(Two6, "Circle", Circle);
      __publicField2(Two6, "Ellipse", Ellipse);
      __publicField2(Two6, "Line", Line);
      __publicField2(Two6, "Points", Points);
      __publicField2(Two6, "Polygon", Polygon);
      __publicField2(Two6, "Rectangle", Rectangle);
      __publicField2(Two6, "RoundedRectangle", RoundedRectangle);
      __publicField2(Two6, "Star", Star);
      __publicField2(Two6, "CanvasRenderer", Renderer2);
      __publicField2(Two6, "SVGRenderer", Renderer22);
      __publicField2(Two6, "WebGLRenderer", Renderer3);
      __publicField2(Two6, "Commands", Commands2);
      __publicField2(Two6, "Utils", Utils);
      ...
      function updateDimensions(width, height) {
        this.width = width;
        this.height = height;
        this.trigger(Events2.Types.resize, width, height);
      }
      var raf = dom.getRequestAnimationFrame();
      function loop() {
        for (let i = 0; i < Two6.Instances.length; i++) {
          const t = Two6.Instances[i];
          if (t.playing) {
            t.update();
          }
        }
        Two6.nextFrameID = raf(loop);
      }
      raf.init = function() {
        loop();
        raf.init = function() {
      ...
      return __toCommonJS2(two_exports);
    })().default;
    (function() {
      if (typeof exports === "object" && typeof module2 !== "undefined") {
        module2.exports = Two5;
      }
    })();
  }
});
...
// src/wiremark.js
var import_two3 = __toESM(require_two());

// src/entity.js
var import_two2 = __toESM(require_two());

// src/connection.js
var import_two = __toESM(require_two());
...
function decomposeMatrix(matrix2, b, c, d, e, f) {
  let a;
  if (arguments.length <= 1) {
    a = matrix2.a;
    b = matrix2.b;
...
function setMatrix(matrix2) {
  Matrix = matrix2;
}
function getComputedMatrix(object, matrix2) {
  matrix2 = matrix2 && matrix2.identity() || new Matrix();
  let parent = object;
  const matrices = [];
  while (parent && parent._matrix) {
    matrices.push(parent._matrix);
...
var _Vector = class extends Events {
  ...
  rotate(radians) {
    ...
    this.x = x * cos3 - y * sin3;
    this.y = x * sin3 + y * cos3;
    return this;
  }
};
var Vector = _Vector;
...
var _Group = class extends Shape {
  ...
  getBoundingClientRect(shallow) {
    let rect, matrix2, a, b, c, d, tc, lc, rc, bc;
    this._update(true);
    let left = Infinity, right = -Infinity, top = Infinity, bottom = -Infinity;
    const regex2 = /texture|gradient/i;
    matrix2 = shallow ? this._matrix : getComputedMatrix(this);
    for (let i = 0; i < this.children.length; i++) {
      const child = this.children[i];
    ...
    if (shallow) {
      a = matrix2.multiply(left, top, 1);
      b = matrix2.multiply(left, bottom, 1);
      c = matrix2.multiply(right, top, 1);
      d = matrix2.multiply(right, bottom, 1);
...
var canvas = {
  ...
  group: {
    ...
    render: function(ctx) {
      ...
      this._update();
      const matrix2 = this._matrix.elements;
      const parent = this.parent;
      this._renderer.opacity = this._opacity * (parent && parent._renderer ? parent._renderer.opacity : 1);
      const mask = this._mask;
      const defaultMatrix = isDefaultMatrix(matrix2);
      const shouldIsolate = !defaultMatrix || !!mask;
      if (!this._renderer.context) {
        this._renderer.context = {};
      }
  ...
  path: {
    render: function(ctx, forced, parentClipped) {
      let matrix2, stroke, linewidth, fill, opacity, visible, cap, join, miter, closed2, commands, length, last, prev, a, b, c, d, ux, uy, vx, vy, ar, bl, br, cl, x, y, mask, clip, defaultMatrix, isOffset, dashes2, po;
      po = this.parent && this.parent._renderer ? this.parent._renderer.opacity : 1;
      mask = this._mask;
      clip = this._clip;
      opacity = this._opacity * (po || 1);
      ...
      length = commands.length;
      last = length - 1;
      defaultMatrix = isDefaultMatrix(matrix2);
      dashes2 = this.dashes;
      if (!defaultMatrix) {
        ctx.save();
        ctx.transform(matrix2[0], matrix2[3], matrix2[1], matrix2[4], matrix2[2], matrix2[5]);
      }
      if (mask) {
        canvas[mask._renderer.type].render.call(mask, ctx, true);
      }
...
function renderArcEstimate(ctx, ox, oy, rx, ry, startAngle, endAngle, clockwise, xAxisRotation) {
  ...
  for (let i = 0; i < Constants.Resolution; i++) {
    ...
    let y = oy + ry * Math.sin(angle);
    if (xAxisRotation !== 0) {
      const cos3 = Math.cos(xAxisRotation);
      const sin3 = Math.sin(xAxisRotation);
      const tx = x - ox;
      const ty = y - oy;
      x = tx * cos3 - ty * sin3 + ox;
      y = tx * sin3 + ty * cos3 + oy;
    }
    ctx.lineTo(x, y);
  }
}
...
var _Path = class extends Shape {
  ...
  getBoundingClientRect(shallow) {
    let matrix2, border, l, i, v0, v1, c0x, c0y, c1x, c1y, a, b, c, d;
    let left = Infinity, right = -Infinity, top = Infinity, bottom = -Infinity;
    this._update(true);
    matrix2 = shallow ? this._matrix : getComputedMatrix(this);
    border = (this.linewidth || 0) / 2;
  ...
  getPointAt(t, obj) {
    ...
    const t1x = lerp2(x1, x2, t);
    const t1y = lerp2(y1, y2, t);
    const t2x = lerp2(x2, x3, t);
    const t2y = lerp2(y2, y3, t);
    const t3x = lerp2(x3, x4, t);
    const t3y = lerp2(y3, y4, t);
    const brx = lerp2(t1x, t2x, t);
    const bry = lerp2(t1y, t2y, t);
    const alx = lerp2(t2x, t3x, t);
    const aly = lerp2(t2y, t3y, t);
    if (_.isObject(obj)) {
      obj.x = x;
      obj.y = y;
...
var Connection = class extends import_two.default.Group {
  _name = "connection";
  offset = new import_two.default.Vector();
  constructor(source, target, name) {
    const points = [
      new import_two.default.Anchor(),
      new import_two.default.Anchor(),
      new import_two.default.Anchor(),
      new import_two.default.Anchor()
    ];
    ...
    if (typeof name === "string" && name.length > 0) {
      label = this.label = new import_two.default.Text(name, 0, 0, textStyles);
      label.size *= 0.75;
      this.name = name;
      this.add(label);
    }
    ...
    function update() {
      ...
      if (label) {
        ...
        const angle = import_two.default.Vector.angleBetween(b, a);
        const ox = label.size * Math.cos(angle - HALF_PI2);
        const oy = label.size * Math.sin(angle - HALF_PI2);
...
// src/entity.js
var _Entity = class extends import_two2.default.Group {
  connections = [];
  constructor(name) {
    super();
    const shape = new import_two2.default.RoundedRectangle(0, 0, unit * 1.5, unit, 8);
    const text = new import_two2.default.Text(name, 0, 0, textStyles);
    shape.noStroke();
    const alpha = 0.66;
...
// src/wiremark.js
var emptyMatch = ["", ""];
var Wiremark = class extends import_two3.default.Group {
  _instructions = null;
  constructor(instructions) {
    super();
    this.isWiremark = true;
    this.instructions = instructions;
    this.connections = new import_two3.default.Group();
    this.connections.name = "connections";
    this.entities = new import_two3.default.Group();
...
var import_two4 = __toESM(require_two());
...
var Surface = class {
  ...
  limits(min4, max4) {
    const min_exists = typeof min4 !== "undefined";
    const max_exists = typeof max4 !== "undefined";
    if (!max_exists && !min_exists) {
      return { min: this.min, max: this.max };
    }
    this.min = min_exists ? min4 : this.min;
    this.max = max_exists ? max4 : this.max;
    return this;
  }
  apply(px, py, s) {
...
var _ZUI = class {
  ...
  static Clamp(v, min4, max4) {
    return Math.min(Math.max(v, min4), max4);
  }
  ...
  addLimits(min4, max4) {
    if (typeof min4 !== "undefined") {
      if (this.limits.scale.min) {
        this.limits.scale.min = Math.max(min4, this.limits.scale.min);
      } else {
        this.limits.scale.min = min4;
      }
    }
    ...
    if (this.limits.scale.max) {
      this.limits.scale.max = Math.min(max4, this.limits.scale.max);
    } else {
      this.limits.scale.max = max4;
    }
    return this;
  }
  clientToSurface(x, y) {
...
function Component(props) {
  ...
  const [grabbing, setGrabbing] = (0, import_react.useState)("");
  (0, import_react.useEffect)(mount, []);
  (0, import_react.useEffect)(update, [props.instructions]);
  ...
  function mount() {
    ...
    function addZUI(stage) {
      ...
      const mouse = new import_two4.default.Vector();
      let touches = [];
      let moving = null;
      let distance = 0;
